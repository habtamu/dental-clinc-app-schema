...
CREATE OR REPLACE VIEW payment.salesreport AS 
 ...
 SELECT 'EDNA DENTAL SPECIALTY CLINIC'::text AS name,
    'ኤድና ልዩ የጥርስ ክሊኒክ'::text AS nameam,
    'Tel: 091 1477255/ Mob:091 1477255'::text AS tel,
    'around CMC altad building 4th Floor'::text AS pobox,
    'Tin: 0006208856'::text AS tin,
