...
SELECT 'NOL DENTAL SPECIALTY CLINIC No 2'::text AS name,
    'ኖል የጥርስ ልዩ ክሊኒክ ቁጥር 2'::text AS nameam,
    'Tel:091 4796361 / '::text AS tel,
    'Bole, Addis Ababa'::text AS pobox,
    'Tin: 0024881486'::text AS tin,
