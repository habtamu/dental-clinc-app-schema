...
CREATE OR REPLACE VIEW payment.salesreport AS 
 ...
 SELECT 'FISHKTA DENTAL CLINIC'::text AS name,
    'ፍሉይ ሕክምና ስኒ ፍሽኽታ'::text AS nameam,
    'Tel: +251 034 4450885/ Mob:+251 091 3453230'::text AS tel,
    'Adigrat, Tigray'::text AS pobox,
    'Tin: 0040766359'::text AS tin,
